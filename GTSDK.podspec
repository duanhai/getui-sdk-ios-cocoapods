Pod::Spec.new do |s|
  ...
  s.version      = "2.5.5.1"
  # 简介
  s.summary      = "个推iOS SDK CocoaPods集成库,不包含定位符号的版本"

  # 项目主页地址
  s.homepage     = "https://github.com/duanhai/getui-sdk-ios-cocoapods"
  # 许可证/所采用的授权版本
  s.license      = 'MIT'
  # 库的作者
  s.author       = { "个推" => "support@getui.com" }
  # 项目的地址
  s.source       = { :git => "https://github.com/duanhai/getui-sdk-ios-cocoapods.git", :tag => s.version }
  ...
  s.ios.frameworks = 'SystemConfiguration', 'CFNetwork','CoreTelephony','AVFoundation','Security'
